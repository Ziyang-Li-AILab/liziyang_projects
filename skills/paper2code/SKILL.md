...
Run the helper script to fetch and parse the paper. Scripts live in this skill folder (`~/.cursor/skills/paper2code/scripts/` on a global Cursor install):
```bash
python ~/.cursor/skills/paper2code/scripts/fetch_paper.py {ARXIV_ID} .paper2code_work/{ARXIV_ID}/
```
Then run structure extraction:
```bash
python ~/.cursor/skills/paper2code/scripts/extract_structure.py .paper2code_work/{ARXIV_ID}/paper_text.md .paper2code_work/{ARXIV_ID}/
```
